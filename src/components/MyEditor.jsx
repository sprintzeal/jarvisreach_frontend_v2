...
import ReactQuill, { Quill as ReactQuillInstance } from "react-quill"; // Import the Quill instance from react-quill

ReactQuillInstance.register("modules/imageResize", ImageResize);

const MyEditor = ({ field = {}, form = {}, handleContentChange }) => {
