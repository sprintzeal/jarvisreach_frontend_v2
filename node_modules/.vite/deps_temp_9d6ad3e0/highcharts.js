 ...
 - ${i4}: ${e4}`, h2 && (l2 += encodeURI(i4) + "=" + encodeURI(e4));
        ...
        return r.jQuery && (r.jQuery.fn.highcharts = function() {
          ...
          return function t4(e4, r3, o2, a2) {
            ...
            C(e4, function(i4, d2) {
              if (!a2 && s2 && s2.indexOf(d2) > -1 && r3[d2]) {
                i4 = f(i4), o2[d2] = [];
                for (let e5 = 0; e5 < Math.max(i4.length, r3[d2].length); e5++) r3[d2][e5] && (void 0 === i4[e5] ? o2[d2][e5] = r3[d2][e5] : (o2[d2][e5] = {}, t4(i4[e5], r3[d2][e5], o2[d2][e5], a2 + 1)));
              } else l(i4, true) && !i4.nodeType ? (o2[d2] = h(i4) ? [] : {}, t4(i4, r3[d2] || {}, o2[d2], a2 + 1), 0 !== Object.keys(o2[d2]).length || "colorAxis" === d2 && 0 === a2 || delete o2[d2]) : (e4[d2] !== r3[d2] || d2 in e4 && !(d2 in r3)) && "__proto__" !== d2 && "constructor" !== d2 && (o2[d2] = n2[d2]);
            });
          }(t3, e3, r2, 0), r2;
          ...
          return t3.forEach((t4) => {
            if (t4.length > 1) for (o2 = s2 = t4.length - 1; o2 > 0; o2--) (r2 = t4[o2] - t4[o2 - 1]) < 0 && !a2 ? (e3 == null ? void 0 : e3(), e3 = void 0) : r2 && (void 0 === i3 || r2 < i3) && (i3 = r2);
          }), i3;
        ...
        class m {
          ...
          getTimeTicks(t3, e3, i3, r2) {
            ...
            if (r2 = c(r2, 1), s(e3)) {
              ...
              let p3 = m2.getTime();
              for (a2 = 1; p3 < i3; ) g2.push(p3), x === u.year ? p3 = d2.makeTime(n2 + a2 * y, 0) : x === u.month ? p3 = d2.makeTime(n2, t4 + a2 * y) : h2 && (x === u.day || x === u.week) ? p3 = d2.makeTime(n2, t4, o2 + a2 * y * (x === u.day ? 1 : 7)) : h2 && x === u.hour && y > 1 ? p3 = d2.makeTime(n2, t4, o2, c2 + a2 * y) : p3 += x * y, a2++;
          ...
          getDateFormat(t3, e3, i3, s2) {
            ...
            for (n2 in u) {
              ...
              if (a2[n2] && r2.substr(a2[n2]) !== o2.substr(a2[n2])) break;
              "week" !== n2 && (h2 = n2);
            }
        ...
        class o {
          ...
          constructor(e3) {
            ...
            if ("object" == typeof e3 && void 0 !== e3.stops) this.stops = e3.stops.map((t3) => new o(t3[1]));
              ...
              if (!s2) for (r2 = o.parsers.length; r2-- && !s2; ) (i3 = (a = o.parsers[r2]).regex.exec(e3)) && (s2 = a.parse(i3));
            }
            s2 && (this.rgba = s2);
          }
          get(t3) {
        ...
        class I {
          ...
          zIndexSetter(t3, e3) {
            ...
            if (x(t3) ? (o2.setAttribute("data-z-index", t3), t3 = +t3, this[e3] === t3 && (p2 = false)) : x(this[e3]) && o2.removeAttribute("data-z-index"), this[e3] = t3, p2) {
              for ((t3 = this.zIndex) && s2 && (s2.handleZ = true), u2 = (n2 = r2.childNodes).length - 1; u2 >= 0 && !d2; u2--) c2 = !x(l2 = (h2 = n2[u2]).getAttribute("data-z-index")), h2 !== o2 && (t3 < 0 && c2 && !a2 && !u2 ? (r2.insertBefore(o2, n2[u2]), d2 = true) : (P(l2) <= t3 || c2 && (!x(t3) || t3 >= 0)) && (r2.insertBefore(o2, n2[u2 + 1]), d2 = true));
        ...
        return { arc: r, callout: function(t3, e3, s2, r2, o2) {
          ...
          if (t3 + l > s2 - h) {
            if (d > e3 + h && d < e3 + r2 - h) c.splice(3, 1, ["L", t3 + s2, d - 6], ["L", t3 + s2 + 6, d], ["L", t3 + s2, d + 6], ["L", t3 + s2, e3 + r2 - n]);
            else if (l < s2) {
              let i3 = d < e3 + h, o3 = i3 ? e3 : e3 + r2;
              c.splice(i3 ? 2 : 5, 0, ["L", l, d], ["L", t3 + s2 - n, o3]);
            } else c.splice(3, 1, ["L", t3 + s2, r2 / 2], ["L", l, d], ["L", t3 + s2, r2 / 2], ["L", t3 + s2, e3 + r2 - n]);
          } else if (t3 + l < h) {
            if (d > e3 + h && d < e3 + r2 - h) c.splice(7, 1, ["L", t3, d + 6], ["L", t3 - 6, d], ["L", t3, d - 6], ["L", t3, e3 + n]);
            else if (l > 0) {
              let i3 = d < e3 + h, s3 = i3 ? e3 : e3 + r2;
              c.splice(i3 ? 1 : 6, 0, ["L", l, d], ["L", t3 + n, s3]);
            } else c.splice(7, 1, ["L", t3, r2 / 2], ["L", l, d], ["L", t3, r2 / 2], ["L", t3, e3 + n]);
          } else d > r2 && l < s2 - h ? c.splice(5, 1, ["L", l + 6, e3 + r2], ["L", l, e3 + r2 + 6], ["L", l - 6, e3 + r2], ["L", t3 + n, e3 + r2]) : d < 0 && l > h && c.splice(1, 1, ["L", l - 6, e3], ["L", l, e3 - 6], ["L", l + 6, e3], ["L", s2 - n, e3]);
          return c;
        ...
        return class {
          ...
          modifyDOM() {
            ...
            let h2 = (t4, o2) => {
              ...
              if (this.ellipsis) h3 && this.truncate(t4, h3, void 0, 0, Math.max(0, n2 - 0.8 * c2), (t5, e4) => t5.substring(0, e4) + "…");
              else if (d2) {
                let h4 = [], d3 = [];
                for (; o2.firstChild && o2.firstChild !== t4; ) d3.push(o2.firstChild), o2.removeChild(o2.firstChild);
                for (; l3.length; ) l3.length && !this.noWrap && p > 0 && (h4.push(t4.textContent || ""), t4.textContent = l3.join(" ").replace(/- /g, "-")), this.truncate(t4, void 0, l3, 0 === p && u || 0, n2, (t5, e4) => l3.slice(0, e4).join(" ").replace(/- /g, "-")), u = e3.actualWidth, p++;
                d3.forEach((e4) => {
          ...
          truncate(t3, e3, i3, s2, r2, o2) {
            ...
            if (h2.rotation = 0, s2 + (n2 = g(t3.textContent.length)) > r2) {
              for (; c2 <= p; ) u = Math.ceil((c2 + p) / 2), i3 && (a2 = o2(i3, u)), n2 = g(u, a2 && a2.length - 1), c2 === p ? c2 = p + 1 : n2 > r2 ? p = u - 1 : c2 = u;
        ...
        class W {
          ...
          symbol(t3, e3, i3, s2, r2, o2) {
            ...
            if (m2) "number" == typeof e3 && (n2 = m2.call(this.symbols, e3 || 0, i3 || 0, s2 || 0, r2 || 0, o2)), a2 = this.path(n2), d2.styledMode || a2.attr("fill", "none"), L(a2, { symbolName: f2 || void 0, x: e3, y: i3, width: s2, height: r2 }), o2 && L(a2, o2);
            else if (u2) {
              h2 = t3.match(c2)[1];
        ...
        class N {
          ...
          defaultLabelFormatter() {
            ...
            else if (d2 && n2 && l2 >= 1e3) for (; d2-- && void 0 === u2; ) l2 >= (p2 = Math.pow(h2, d2 + 1)) && 10 * i3 % p2 == 0 && null !== n2[d2] && 0 !== i3 && (u2 = e3(i3 / p2, -1) + n2[d2]);
            ...
            k(this, "getSeriesExtremes", null, function() {
              e3.hasVisibleSeries = false, e3.dataMin = e3.dataMax = e3.threshold = void 0, e3.softThreshold = !e3.isXAxis, e3.series.forEach((i3) => {
                if (i3.reserveSpace()) {
                  ...
                  if (e3.hasVisibleSeries = true, e3.positiveValuesOnly && 0 >= (o2 || 0) && (o2 = void 0), e3.isXAxis) (r2 = i3.xData) && r2.length && (r2 = e3.logarithmic ? r2.filter((t4) => t4 > 0) : r2, a2 = (t3 = i3.getXExtremes(r2)).min, n2 = t3.max, T(a2) || a2 instanceof Date || (r2 = r2.filter(T), a2 = (t3 = i3.getXExtremes(r2)).min, n2 = t3.max), r2.length && (e3.dataMin = Math.min(E(e3.dataMin, a2), a2), e3.dataMax = Math.max(E(e3.dataMax, n2), n2)));
                  else {
          ...
          getLinearTickPositions(t3, e3, i3) {
            ...
            if (x(a2 + t3) === a2 && (o2 = 20), this.single) return [e3];
            for (s2 = a2; s2 <= n2 && (h2.push(s2), (s2 = x(s2 + t3, o2)) !== r2); ) r2 = s2;
            return h2;
          }
          ...
          getMinorTickPositions() {
            ...
            if (a2 && a2 / i3 < this.len / 3) {
              ...
              else if (this.dateTime && "auto" === this.getMinorTickInterval()) n2 = n2.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(i3), r2, o2, t3.startOfWeek));
              else for (h2 = r2 + (e3[0] - r2) % i3; h2 <= o2 && h2 !== n2[0]; h2 += i3) n2.push(h2);
            }
          ...
          setTickPositions() {
            ...
            if (this.tickmarkOffset = this.categories && "between" === t3.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0, this.minorTickInterval = "auto" === s2 && this.tickInterval ? this.tickInterval / t3.minorTicksPerMajor : s2, this.single = this.min === this.max && y(this.min) && !this.tickAmount && (this.min % 1 == 0 || false !== t3.allowDecimals), e3) n2 = e3.slice();
            ...
            if (T(n2) && (u2 = n2 < 0.5 ? Math.ceil(n2 * (a2 - 1)) : Math.floor(n2 * (a2 - 1)), r2.reversed && (u2 = a2 - 1 - u2)), t3.hasData() && T(s2) && T(i3)) {
              ...
              if (T(u2) && T(t3.threshold)) {
                for (; o2[u2] !== l2 || o2.length !== a2 || o2[0] > s2 || o2[o2.length - 1] < i3; ) {
                  for (o2.length = 0, o2.push(t3.threshold); o2.length < a2; ) void 0 === o2[u2] || o2[u2] > t3.threshold ? f2() : g2();
                  if (p2 > 8 * t3.tickInterval) break;
                  p2 *= 2;
                }
                n3();
              } else if (h2 < a2) {
                for (; o2.length < a2; ) o2.length % 2 || s2 === l2 ? g2() : f2();
                n3();
              }
              if (y(e3)) {
          ...
          unsquish() {
            ...
            if (i3) {
              if (!t3.staggerLines && (T(o2) ? p2 = [o2] : r2 < t3.autoRotationLimit && (p2 = t3.autoRotation)), p2) {
                let t4, e4;
                for (let i4 of p2) (i4 === o2 || i4 && i4 >= -90 && i4 <= 90) && (e4 = (t4 = h2(Math.abs(a2 / Math.sin(u * i4)))) + Math.abs(i4 / 360)) < c2 && (c2 = e4, d2 = i4, l2 = t4);
              }
            } else l2 = h2(0.75 * a2);
          ...
          renderUnsquish() {
            ...
            else if (n2 && (p2 = h2, !c2)) for (u2 = "clip", m2 = i3.length; !a2 && m2--; ) (f2 = s2[i3[m2]].label) && ("ellipsis" === f2.styles.textOverflow ? f2.css({ textOverflow: "clip" }) : f2.textPxLength > n2 && f2.css({ width: n2 + "px" }), f2.getBBox().height > this.len / i3.length - (d2.h - d2.f) && (f2.specificTextOverflow = "ellipsis"));
        ...
        return function(t3) {
          ...
          class a {
            ...
            getLogTickPositions(t4, e4, i3, o2) {
              ...
              if (o2 || (this.minorAutoInterval = void 0), t4 >= 0.5) t4 = Math.round(t4), l = a2.getLinearTickPositions(t4, e4, i3);
              else if (t4 >= 0.08) {
                let s2, r2, a3, n2, h2, d, c;
                let p = Math.floor(e4);
                for (s2 = t4 > 0.3 ? [1, 2, 4] : t4 > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9], r2 = p; r2 < i3 + 1 && !c; r2++) for (a3 = 0, n2 = s2.length; a3 < n2 && !c; a3++) (h2 = this.log2lin(this.lin2log(r2) * s2[a3])) > e4 && (!o2 || d <= i3) && void 0 !== d && l.push(d), d > i3 && (c = true), d = h2;
              } else {
        ...
        return function(t3) {
          ...
          function h(t4, e4, i3) {
            ...
            if (h2 && s2) for (n2 && (c2 = h2.toString() === s2.toString(), d2 = 0), l2 = 0; l2 < h2.length; l2 += 2) {
        ...
        class T {
          ...
          getAnchor(t3, e3) {
            ...
            if ((t3 = w(t3))[0].series && t3[0].series.yAxis && !t3[0].series.yAxis.options.reversedStacks && (t3 = t3.slice().reverse()), this.followPointer && e3) void 0 === e3.chartX && (e3 = r2.normalize(e3)), i3 = [e3.chartX - n2, e3.chartY - a2];
          ...
          refresh(t3, e3) {
            ...
            if (this.distance = k(C2.tooltipOptions.distance, 16), false === v2) this.hide();
              ...
              if (this.split && this.allowShared) this.renderSplit(v2, n2);
              else {
                let t4 = m2, o2 = x2;
            ...
            let B = t3.slice(0, e3.length + 1).reduce(function(t4, s3, r3) {
              if (false !== s3 && "" !== s3) {
                ...
                let { anchorX: x2, anchorY: v3 } = function(t5) {
                  ...
                  if (s4) e4 = Math.max(n2 + r4, n2), i4 = h2 + a2 / 2;
                  else {
        ...
        class k {
          ...
          optionsToObject(t3) {
            ...
            else if (g(t3)) for (!i3 && t3.length > r2 && ("string" == (a2 = typeof t3[0]) ? o2.name = t3[0] : "number" === a2 && (o2.x = t3[0]), n2++); h2 < r2; ) i3 && void 0 === t3[n2] || (s2[h2].indexOf(".") > 0 ? k.prototype.setNestedProperty(o2, t3[n2], s2[h2]) : o2[s2[h2]] = t3[n2]), n2++, h2++;
          ...
          pos(t3, e3 = this.plotY) {
            if (!this.destroyed) {
              ...
              if (m(i3) && m(e3)) return t3 && (n2 = o2 ? o2.pos : r2.plotLeft, h2 = a2 ? a2.pos : r2.plotTop), r2.inverted && o2 && a2 ? [a2.len - e3 + h2, o2.len - i3 + n2] : [i3 + n2, e3 + h2];
            }
          }
          resolveColor() {
          ...
          update(t3, e3, i3, s2) {
            ...
            function d2() {
              ...
              n2 && d3 && (o2.graphic = n2.destroy(), delete o2.hasMockGraphic), x(t3, true) && (n2 && n2.element && t3 && t3.marker && void 0 !== t3.marker.symbol && (o2.graphic = n2.destroy()), (t3 == null ? void 0 : t3.dataLabels) && o2.dataLabel && (o2.dataLabel = o2.dataLabel.destroy())), r2 = o2.index, a2.updateParallelArrays(o2, r2), l2.data[r2] = x(l2.data[r2], true) || x(t3, true) ? o2.options : b(t3, l2.data[r2]), a2.isDirty = a2.isDirtyData = true, !a2.fixedBox && a2.hasCartesianSeries && (h2.isDirtyBox = true), "point" === l2.legendType && (h2.isDirtyLegend = true), e3 && h2.redraw(i3);
            }
          ...
          manageEvent(t3) {
            ...
            f(i3) && (!((_b = this.hcEvents) == null ? void 0 : _b[t3]) || ((_d = (_c = this.hcEvents) == null ? void 0 : _c[t3]) == null ? void 0 : _d.map((t4) => t4.fn).indexOf(i3)) === -1) ? (h(this, t3, i3), this.hasImportedEvents = true) : this.hasImportedEvents && !i3 && ((_e = this.hcEvents) == null ? void 0 : _e[t3]) && (S(this, t3), delete this.hcEvents[t3], Object.keys(this.hcEvents) || (this.hasImportedEvents = false));
          }
          setState(e3, i3) {
            var _a;
        ...
        class T {
          ...
          proximatePositions() {
            ...
            }, this), p(i3, e3.plotHeight))) t3 = r2.item.legendItem || {}, v(r2.pos) && (t3.y = e3.plotTop - e3.spacing[0] + r2.pos);
          }
          render() {
          ...
          setItemEvents(t3, e3, i3) {
            ...
            for (let i4 of d2) i4 && i4.on("mouseover", function() {
        ...
        class X {
          ...
          setData(t3, e3 = true, i3, s2) {
            ...
            if (l2 && l2.enabled && (t3 = this.sortData(t3)), h2.options.chart.allowMutatingData && false !== s2 && M2 && a2 && !r2.cropped && !r2.hasGroupedData && r2.visible && !r2.boosted && (b2 = this.updateData(t3, i3)), !b2) {
              if (r2.xIncrement = null, r2.colorCounter = 0, this.parallelArrays.forEach(function(t4) {
                ...
                if (j(C2 = r2.getFirstValidPoint(t3))) for (x2 = 0; x2 < M2; x2++) p2[x2] = this.autoIncrement(), u2[x2] = t3[x2];
                else if (I(C2)) {
                  if (f2) {
                    if (C2.length === f2) for (x2 = 0; x2 < M2; x2++) p2[x2] = this.autoIncrement(), u2[x2] = t3[x2];
                    else for (x2 = 0; x2 < M2; x2++) y2 = t3[x2], p2[x2] = y2[0], u2[x2] = y2.slice(1, f2 + 1);
                  } else if (m2 && (v2 = m2.indexOf("x"), S2 = m2.indexOf("y"), v2 = v2 >= 0 ? v2 : 0, S2 = S2 >= 0 ? S2 : 1), 1 === C2.length && (S2 = 0), v2 === S2) for (x2 = 0; x2 < M2; x2++) p2[x2] = this.autoIncrement(), u2[x2] = t3[x2][S2];
                  else for (x2 = 0; x2 < M2; x2++) y2 = t3[x2], p2[x2] = y2[v2], u2[x2] = y2[S2];
                } else A(12, false, h2);
              } else for (x2 = 0; x2 < M2; x2++) y2 = { series: r2 }, r2.pointClass.prototype.applyOptions.apply(y2, [t3[x2]]), r2.updateParallelArrays(y2, x2);
              for (u2 && B(u2[0]) && A(14, true, h2), r2.data = [], r2.options.data = r2.userOptions.data = t3, x2 = a2; x2--; ) (_a = o2[x2]) == null ? void 0 : _a.destroy();
          ...
          getProcessedData(t3) {
            let e3 = this, i3 = e3.xAxis, s2 = e3.options.cropThreshold, r2 = i3 == null ? void 0 : i3.logarithmic, o2 = e3.isCartesian, a2, n2, h2 = 0, l2, d2, c2, p2 = e3.xData, u2 = e3.yData, g2 = false, f2 = p2.length;
          ...
          generatePoints() {
            ...
            for (h2 && n2 && (this.options.keys = false), g2 = 0; g2 < o2; g2++) p2 = a2 + g2, n2 ? ((u2 = new r2(this, [i3[g2]].concat(G(s2[g2])))).dataGroup = this.groupMap[d2 + g2], u2.dataGroup.options && (u2.options = u2.dataGroup.options, T(u2, u2.dataGroup.options), delete u2.dataLabels)) : (u2 = f2[p2]) || void 0 === e3[p2] || (f2[p2] = u2 = new r2(this, e3[p2], i3[g2])), u2 && (u2.index = n2 ? d2 + g2 : p2, l2[g2] = u2);
            if (this.options.keys = h2, f2 && (o2 !== (c2 = f2.length) || n2)) for (g2 = 0; g2 < c2; g2++) g2 !== a2 || n2 || (g2 += o2), f2[g2] && (f2[g2].destroyElements(), f2[g2].plotX = void 0);
          ...
          getExtremes(t3, e3) {
            ...
            for (i3 && (b2 = (d2 = i3.getExtremes()).min, v2 = d2.max), f2 = 0; f2 < C2; f2++) if (u2 = k2[f2], c2 = (j(g2 = t3[f2]) || I(g2)) && ((j(g2) ? g2 > 0 : g2.length) || !a2), p2 = e3 || this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || !i3 || (k2[f2 + o2] || u2) >= b2 && (k2[f2 - o2] || u2) <= v2, c2 && p2) {
          ...
          translate() {
            ...
            for (p2 = 0; p2 < n2; p2++) {
              let t4;
              let n3 = a2[p2], y2 = n3.x, b2, S2, k2 = n3.y, M2 = n3.low, w2 = e3 && ((_a = o2.stacking) == null ? void 0 : _a.stacks[(this.negStacks && k2 < (c2 ? 0 : d2) ? "-" : "") + this.stackKey]);
          ...
          drawPoints(t3 = this.points) {
            ...
            if (false !== p2.enabled || this._hasPointMarkers) for (e3 = 0; e3 < t3.length; e3++) if (r2 = (s2 = (i3 = t3[e3]).graphic) ? "animate" : "attr", o2 = i3.marker || {}, a2 = !!i3.marker, (f2 && void 0 === o2.enabled || o2.enabled) && !i3.isNull && false !== i3.visible) {
          ...
          markerAttribs(t3, e3) {
            ...
            let d2 = t3.pos();
            return j(l2) && d2 && (i3.crisp && (d2[0] = S(d2[0], t3.hasImage ? 0 : "rect" === o2 ? (s2 == null ? void 0 : s2.lineWidth) || 0 : 1)), a2.x = d2[0] - l2, a2.y = d2[1] - l2), l2 && (a2.width = a2.height = 2 * l2), a2;
          }
          pointAttribs(t3, e3) {
          ...
          searchKDTree(t3, e3, i3) {
            ...
            if (this.kdTree || this.buildingKdTree || this.buildKDTree(i3), this.kdTree) return function t4(e4, i4, n3, l2) {
              ...
              !function(t5, e5) {
                var _a2;
                let i5 = t5[r2], s3 = e5[r2], a3 = C(i5) && C(s3) ? i5 - s3 : null, n4 = t5[o2], l3 = e5[o2], d3 = C(n4) && C(l3) ? n4 - l3 : 0, c3 = h2 && ((_a2 = e5.marker) == null ? void 0 : _a2.radius) || 0;
          ...
          setState(t3, e3) {
            ...
            if (t3 = t3 || "", i3.state !== t3 && ([i3.group, i3.markerGroup, i3.dataLabelsGroup].forEach(function(e4) {
              ...
              if (t3 && (h2 = a2[t3].lineWidth || h2 + (a2[t3].lineWidthPlus || 0), l2 = N(a2[t3].opacity, l2)), r2 && !r2.dashstyle && j(h2)) for (let t4 of [r2, ...this.zones.map((t5) => t5.graph)]) t4 == null ? void 0 : t4.animate({ "stroke-width": h2 }, n2);
        ...
        class Q {
          ...
          propFromSeries() {
            ...
            ["inverted", "angular", "polar"].forEach(function(a2) {
              for (e3 = A[r2.type], i3 = r2[a2] || e3 && e3.prototype[a2], t3 = o2 && o2.length; !i3 && t3--; ) (e3 = A[o2[t3].type]) && e3.prototype[a2] && (i3 = true);
              s2[a2] = i3;
            });
          }
          linkSeries(t3) {
          ...
          render() {
            ...
            for (this.plotHeight = Math.max(this.plotHeight - o2, 0); (a2 || n2 || s2 > 1) && h2 < s2; ) {
              ...
              for (let e5 of t3) 0 === h2 ? e5.setScale() : (e5.horiz && a2 || !e5.horiz && n2) && e5.setTickInterval(true);
        ...
        class g {
          ...
          static afterSetSize(t3, e3) {
            ...
            if (!p2.forExport && (o2 ? (t3.scrollablePixelsX = i3 = Math.max(0, o2 - t3.chartWidth), i3 && (t3.scrollablePlotBox = d(t3.plotBox), h2.width = t3.plotWidth += i3, n2[c2 ? "height" : "width"] += i3, r2 = true)) : a2 && (t3.scrollablePixelsY = s2 = Math.max(0, a2 - t3.chartHeight), l(s2) && (t3.scrollablePlotBox = d(t3.plotBox), h2.height = t3.plotHeight += s2, n2[c2 ? "width" : "height"] += s2, r2 = false)), l(r2) && !e3.skipAxes)) for (let e4 of t3.axes) e4.horiz === r2 && (e4.setAxisSize(), e4.setAxisTranslation());
          }
          constructor(t3) {
            var _a;
            let e3;
          ...
          moveFixedElements() {
            ...
            for (let n2 of (s2 && !i3 ? t3 = ".highcharts-yaxis" : s2 && i3 ? t3 = ".highcharts-xaxis" : r2 && !i3 ? t3 = ".highcharts-xaxis" : r2 && i3 && (t3 = ".highcharts-yaxis"), t3 && a2.push(`${t3}:not(.highcharts-radial-axis)`, `${t3}-labels:not(.highcharts-radial-axis-labels)`), a2)) [].forEach.call(e3.querySelectorAll(n2), (t4) => {
        ...
        function S() {
          ...
          n2 && [s2, "-" + s2].forEach((i4) => {
            ...
            for (; s3--; ) a3 = o2[s3], t3 = e3.getStackIndicator(t3, a3, e3.index, i4), h2 = (_a = r2[i4]) == null ? void 0 : _a[a3], (l2 = h2 == null ? void 0 : h2.points[t3.key || ""]) && n2.call(e3, l2, h2, s3);
          });
        }
        function C(t3, e3, i3) {
        ...
        class w {
          ...
          buildStacks() {
            ...
            for (this.resetStacks(), this.usePercentage = false, e3 = a2; e3--; ) t3 = s2[o2 ? e3 : a2 - e3 - 1], r2 && t3.setGroupedPoints(i3), t3.setStackedPoints(i3);
            if (!r2) for (e3 = 0; e3 < a2; e3++) s2[e3].modifyStacks();
        ...
        class h extends s {
          ...
          getGraphPath(t3) {
            ...
            for (let s2 = 0, o3 = t3.length; s2 < o3; ++s2) h2 || (t3[s2].leftCliff = t3[s2].rightCliff = t3[s2].leftNull = t3[s2].rightNull = void 0), i3 = t3[s2].isNull, e3 = n(t3[s2].rectPlotX, t3[s2].plotX), r2 = h2 ? n(t3[s2].yBottom, f) : f, i3 && !m || (m || x(s2, s2 - 1, "left"), i3 && !h2 && m || (c.push(t3[s2]), d.push({ x: s2, plotX: e3, plotY: r2 })), m || x(s2, s2 + 1, "right"));
        ...
        return function(t3) {
          ...
          function i3(t4, e4, i4, s3, r2) {
            ...
            if (x2 && y2) {
              ...
              if (s3 = n({ x: y2[0], y: Math.round(y2[1]), width: 0, height: 0 }, s3 || {}), "plotEdges" === i4.alignTo && this.isCartesian && (s3[l2 ? "x" : "y"] = 0, s3[l2 ? "width" : "height"] = ((_a = this.yAxis) == null ? void 0 : _a.len) || 0), n(i4, { width: a2.width, height: a2.height }), b2 = s3, h2 && this.xAxis && !m2 && this.setDataLabelStartPos(t4, e4, r2, f2, b2), e4.align(c(i4, { width: d3.width, height: d3.height }), false, s3, false), e4.alignAttr.x += p3 * (d3.width - a2.width), e4.alignAttr.y += v2 * (d3.height - a2.height), e4[e4.placed ? "animate" : "attr"]({ x: e4.alignAttr.x + (a2.width - d3.width) / 2, y: e4.alignAttr.y + (a2.height - d3.height) / 2, rotationOriginX: (e4.width || 0) / 2, rotationOriginY: (e4.height || 0) / 2 }), m2 && s3.height >= 0) this.justifyDataLabel(e4, i4, e4.alignAttr, a2, s3, r2);
            ...
            h(this, "drawDataLabels"), ((_a = i4.hasDataLabels) == null ? void 0 : _a.call(i4)) && (e4 = this.initDataLabels(k), t4.forEach((t5) => {
              ...
              f(b(y2, t5.dlOptions || ((_a2 = t5.options) == null ? void 0 : _a2.dataLabels))).forEach((h3, c3) => {
                ...
                if (f2 && (C2 = u(h3[t5.formatPrefix + "Format"], h3.format), S3 = t5.getLabelConfig(), k2 = a(C2) ? o(C2, S3, s3) : (h3[t5.formatPrefix + "Formatter"] || h3.formatter).call(S3, h3), M = h3.rotation, !s3.styledMode && (v2.color = u(h3.color, v2.color, d(i4.color) ? i4.color : void 0, "#000000"), "contrast" === v2.color ? ("none" !== m3 && (P = m3), t5.contrastColor = l2.getContrast("auto" !== P && P || t5.color || i4.color), v2.color = P || !a(b2) && h3.inside || 0 > g(b2 || 0) || n2.stacking ? t5.contrastColor : x2) : delete t5.contrastColor, n2.cursor && (v2.cursor = n2.cursor)), w = { r: h3.borderRadius || 0, rotation: M, padding: h3.padding, zIndex: 1 }, s3.styledMode || (w.fill = "auto" === m3 ? t5.color : m3, w.stroke = "auto" === y3 ? t5.color : y3, w["stroke-width"] = h3.borderWidth), p(w, (t6, e5) => {
                  ...
                  o2 && !h3.useHTML && (A.setTextPath(((_a3 = t5.getDataLabelPath) == null ? void 0 : _a3.call(t5, A)) || t5.graphic, o2), t5.dataLabelPath && !o2.enabled && (t5.dataLabelPath = t5.dataLabelPath.destroy())), A.added || A.add(e4), i4.alignDataLabel(t5, A, h3, void 0, T), A.isActive = true, r2[c3] && r2[c3] !== A && r2[c3].destroy(), r2[c3] = A;
                }
              });
              let h2 = r2.length;
              for (; h2--; ) r2[h2] && r2[h2].isActive ? r2[h2].isActive = false : ((_b = r2[h2]) == null ? void 0 : _b.destroy(), r2.splice(h2, 1));
          ...
          function r2() {
            ...
            t3.visible && ((_a = t3.hasDataLabels) == null ? void 0 : _a.call(t3)) && (e4.forEach((t4) => {
              ...
              (t4.dataLabels || []).forEach((e5, i5) => {
                ...
                0 === i5 && m2[t4.half].push(t4), !p((_a2 = r4 == null ? void 0 : r4.style) == null ? void 0 : _a2.width) && e5.getBBox().width > a2 && (e5.css({ width: Math.round(0.7 * a2) + "px" }), e5.shortened = true), e5.dataLabelPosition = this.getDataLabelPosition(t4, o4), C = Math.max(C, o4);
              });
            }), m2.forEach((e5, a3) => {
              ...
              l2 && (t3.sortByAngle(e5, a3 - 0.5), C > 0 && (f2 = Math.max(0, g2 - c2 - C), m3 = Math.min(g2 + c2 + C, i4.plotHeight), e5.forEach((t4) => {
                ...
                (i5.dataLabels || []).forEach((h2) => {
                  let l3 = h2.options || {}, g3 = i5.distributeBox, f3 = h2.dataLabelPosition, m4 = (f3 == null ? void 0 : f3.natural.y) || 0, b3 = l3.connectorPadding || 0, C2 = 0, k2 = m4, M = "inherit";
                  if (f3) {
                    if (d2 && p(g3) && f3.distance > 0 && (void 0 === g3.pos ? M = "hidden" : (S = g3.size, k2 = y.radialDistributionY(i5, h2))), l3.justify) C2 = y.justify(i5, h2, c2, n2);
        ...
        function o(t3) {
          ...
          for (let i3 = 0; i3 < e3; i3++) (r2 = t3[i3]) && (r2.oldOpacity = r2.opacity, r2.newOpacity = 1, r2.absoluteBox = function(t4) {
            var _a, _b;
          ...
          for (let i3 = 0; i3 < e3; ++i3) {
            ...
            for (let r3 = i3 + 1; r3 < e3; ++r3) l = (n2 = t3[r3]) && n2.absoluteBox, h && l && o2 !== n2 && 0 !== o2.newOpacity && 0 !== n2.newOpacity && "hidden" !== o2.visibility && "hidden" !== n2.visibility && s2(h, l) && ((o2.labelrank < n2.labelrank ? o2 : n2).newOpacity = 0);
          }
          for (let e4 of t3) a(e4, this) && (d = true);
        ...
        function n() {
          ...
          for (let i3 of t3.yAxis || []) i3.stacking && i3.options.stackLabels && !i3.options.stackLabels.allowOverlap && s(i3.stacking.stacks, (t4) => {
            s(t4, (t5) => {
