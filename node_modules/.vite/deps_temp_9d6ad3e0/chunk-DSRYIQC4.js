import {
  ...
  useRootElementName,
  useSlotProps
} from "./chunk-I7VKDKZB.js";
import {
  ButtonBase_default
} from "./chunk-RYKKUEBV.js";
import {
  Transition_default
} from "./chunk-OW432B3H.js";
import {
  require_react_dom
} from "./chunk-3IHV7RO6.js";
import {
  useTheme
} from "./chunk-WUTXEFTS.js";
import {
  GlobalStyles_default,
  useRtl
} from "./chunk-ETBP7XHE.js";
import {
  createSvgIcon,
  debounce_default,
  init_createSvgIcon,
...
} from "./chunk-VQB4E5Q4.js";
import {
  capitalize_default,
  init_capitalize
} from "./chunk-P2DWFXVX.js";
import {
  init_useForkRef,
  useForkRef_default
} from "./chunk-GEV4SLET.js";
import {
...
var require_useThemeWithoutDefault = __commonJS({
  "node_modules/@mui/system/useThemeWithoutDefault.js"(exports) {
    ...
    function useTheme3(defaultTheme = null) {
      const contextTheme = React110.useContext(_styledEngine.ThemeContext);
...
function CssAnimation(props) {
  ...
  const hasExited = React77.useRef(true);
  React77.useEffect(() => {
    if (requestedEnter && hasExited.current) {
      hasExited.current = false;
    }
  }, [requestedEnter]);
  const handleAnimationEnd = React77.useCallback((event) => {
...
var CssTransition = React78.forwardRef(function CssTransition2(props, forwardedRef) {
  const {
    children,
    className,
  ...
  const [isEntering, setIsEntering] = React78.useState(false);
  React78.useEffect(() => {
    if (requestedEnter) {
  ...
  const handleTransitionEnd = React78.useCallback((event) => {
  ...
  return (0, import_jsx_runtime69.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime69.jsx)(InputAdornmentRoot, _extends({
      ...
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime69.jsx)(Typography_default, {
        ...
        children
      }) : (0, import_jsx_runtime70.jsxs)(React93.Fragment, {
...
var ListContext2 = React95.createContext({});
if (true) {
...
var MenuList = React100.forwardRef(function MenuList2(props, ref) {
  ...
  React100.Children.forEach(children, (child, index2) => {
  ...
  const items = React100.Children.map(children, (child, index2) => {
...
var Menu3 = React102.forwardRef(function Menu4(inProps, ref) {
  ...
  let activeItemIndex = -1;
  React102.Children.map(children, (child, index2) => {
  ...
  return (0, import_jsx_runtime81.jsx)(NotchedOutlineRoot, _extends({
    ...
    children: (0, import_jsx_runtime81.jsx)(NotchedOutlineLegend, {
      ...
      children: withLabel ? (0, import_jsx_runtime81.jsx)("span", {
        ...
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span7 || (_span7 = (0, import_jsx_runtime81.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      )
...
var SelectInput = React106.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime87.jsxs)(React106.Fragment, {
...
var Select3 = React108.forwardRef(function Select4(inProps, ref) {
  ...
  return (0, import_jsx_runtime89.jsx)(React108.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DSRYIQC4.js.map
